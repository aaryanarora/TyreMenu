...
var store = new Vue({
  ...
  data: {
    products: [
      ...
      { id: 5, title: 'Tata', category: 'Tata', img: 'PUNCH',size:'195/60R16'},
      ...
      { id: 49, title: 'Tata', category: 'Tata', img: 'HARRIER',size:'235/60R17'},
      { id: 50, title: 'Tata', category: 'Tata', img: 'ALTROZ',size:'195/55R16'},
      { id: 51, title: 'Tata', category: 'Tata', img: 'TIAGO',size:'175/60R15'},
      { id: 52, title: 'Tata', category: 'Tata', img: 'SAFARI',size:'235/70R16'},
      { id: 53, title: 'Tata', category: 'Tata', img: 'TIGOR',size:'175/60R15'},
      { id: 54, title: 'Tata', category: 'Tata', img: 'TIGOR EV',size:'175/65R14'},
      { id: 55, title: 'Tata', category: 'Tata', img: 'NEXON',size:'195/60R16'},
      { id: 56, title: 'Tata', category: 'Tata', img: 'NEXON EV',size:'215/60R16'},
      { id: 57, title: 'Audi', category: 'Audi', img: 'Q2',size:'235/55R19'},
      { id: 58, title: 'Audi', category: 'Audi', img: 'Q5',size:'235/65R17'},
      { id: 59, title: 'Audi', category: 'Audi', img: 'A6',size:'245/45R18'},
      { id: 60, title: 'Audi', category: 'Audi', img: 'A8',size:'235/55R18'},
      { id: 61, title: 'Audi', category: 'Audi', img: 'Q8',size:'275/50R20'},
      { id: 62, title: 'Audi', category: 'Audi', img: 'E-TRON GT',size:'245/45R20;225/55R19'},
      { id: 63, title: 'Audi', category: 'Audi', img: 'RS7',size:'275/35R20'},
      { id: 64, title: 'Audi', category: 'Audi', img: 'S5',size:'245/40R18'},
      { id: 65, title: 'Audi', category: 'Audi', img: 'Q5',size:'235/65R17'},
      { id: 66, title: 'Mercedes Benz', category: 'Mercedes Benz', img: 'GLA',size:'215/60R17'},
      { id: 67, title: 'Mercedes Benz', category: 'Mercedes Benz', img: 'G-CLASS',size:'295/40R21'},
      { id: 68, title: 'Mercedes Benz', category: 'Mercedes Benz', img: 'C-CLASS',size:'205/55R16'},
      { id: 69, title: 'Mercedes Benz', category: 'Mercedes Benz', img: 'E-CLASS',size:'265/35R20'},
      { id: 70, title: 'Mercedes Benz', category: 'Mercedes Benz', img: 'GLS',size:'175/65R15'},
      { id: 71, title: 'Mercedes Benz', category: 'Mercedes Benz', img: 'S-CLASS',size:'175/65R15'},
      { id: 72, title: 'Mercedes Benz', category: 'Mercedes Benz', img: 'GLC',size:'175/65R15'},
      { id: 73, title: 'Mercedes Benz', category: 'Mercedes Benz', img: 'GLE',size:'315/40R21'},
      { id: 74, title: 'BMW', category: 'BMW', img: '3 SERIES',size:'255/40R18'},
      { id: 75, title: 'BMW', category: 'BMW', img: 'iX',size:'255/50R21'},
